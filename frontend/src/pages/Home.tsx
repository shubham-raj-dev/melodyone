...
export default function Home() {
  ...
  const handleSearch = async (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'Enter' && query.trim() !== '') {
      ...
      try {
        ...
        setSearchError("Failed to connect to backend. Please try again.");
      }
      setLoading(false);
    }
  };
  ...
  return (
    <div className="pb-10">
      ...
      {searchError && (
        <div className="mb-8 p-4 bg-red-50 border border-red-200 rounded-2xl text-red-700 font-medium flex items-center gap-2">
